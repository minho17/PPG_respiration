...
def main():
    ...
    for ind_tr, ind_te in kf.split(data):
        ...
        stopper = util.EarlyStopping(best_fitness = 9999999, patience = 5)
        ...
        for i_epoc in range(n_epoc):       
            ...
            if stopper(epoch=i_epoc, fitness=np.mean(tr_loss)):
                break
            ...
            if (i_epoc > 0 and i_epoc % 2 == 0) or i_epoc == n_epoc-1 :
                    ...
                    with torch.no_grad(): 
                        ...
                        with open(file_name_txt, "a") as file:
                            ...
                            file.write( " // tr: " + str('{:.3f}'.format(tr_rr_mae[0])) + " / " + str('{:.3f}'.format(tr_rr_mae[1])))
                            file.write(  " // te: " + str('{:.3f}'.format(te_rr_mae[0])) + " / " + str('{:.3f}'.format(te_rr_mae[1]))  +"\n")
                            # file.write( str(i_epoc) + ": " + str('{:.3f}'.format(tr_mse)) + " / " + str('{:.3f}'.format(te_mse)) +"\n")
        ...
        with open(file_name_txt, "a") as file:
            file.write( "Sub_" + str(ind_te[0]) + ": " + str('{:.3f}'.format(result[ind_te[0],0])) + " / " + str('{:.3f}'.format(result[ind_te[0],1])) + " / " + str('{:.3f}'.format(result[ind_te[0],2])) +"\n")
