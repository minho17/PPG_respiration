...
def main():
    ...
    log.w("\n" + "Final result" + "\n")
    log.w( "Median: " + str('{:.3f}'.format(np.median(results[:,0]))) + " / " + str('{:.3f}'.format(np.median(results[:,1])))  + "\n")
    log.w( "Mean: " + str('{:.3f}'.format(np.mean(results[:,0]))) + " / " + str('{:.3f}'.format(np.mean(results[:,1]))) )
